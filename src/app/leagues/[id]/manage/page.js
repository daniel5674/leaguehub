        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-lg font-bold text-gray-900">
              שחקנים רשומים
              <span className="mr-2 text-sm font-normal text-gray-400">({roster.length})</span>
            </h2>
          </div>
              ...
              {roster.map((player) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`rounded-full px-2.5 py-0.5 text-xs font-bold ${RATING_COLORS[player.rating] || RATING_COLORS.D}`}>
                      {player.rating}
                    </span>
                    <button
                      type="button"
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <select
                        value={rating}
                        onChange={(e) =>
                          setPendingRatings((prev) => ({ ...prev, [key]: e.target.value }))
                        }
